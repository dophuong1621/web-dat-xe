                                ...
                                <div class="col-md-4">
                                    <div class="form-group label-floating ">
                                        ...
                                        <select class="form-control" name="driverGender">
                                            <option value="{{ $driver->driverGender[0]->id }}" selected>{{ $driver->driverGender[0]->gender_name}}</option>
                                            @foreach ($driverGender as $drg)
                                                <option value="{{ $drg->id }}"> {{ $drg->gender_name}} </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group label-floating">
                                        ...
                                        <select class="form-control" name="driverGarage">
                                            <option value="{{ $driver->driverGarage[0]->id }}" selected>{{ $driver->driverGarage[0]->name_garage}}</option>
                                            @foreach ($driverGarage as $dg)
                                                <option value="{{ $dg->id }}"> {{ $dg->name_garage }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group label-floating">
                                        ...
                                        <select class="form-control" name="driverStatus">
                                            <option value="{{ $driver->driverStatus[0]->id}}" selected>{{  $driver->driverStatus[0]->name_status_driver}}</option>
                                            @foreach ($driverStatus as $ds)
                                                <option value="{{ $ds->id }}"> {{ $ds->name_status_driver }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                {{-- <div class="col-md-4">
                                    <div class="form-group label-floating">
                                        ...
                                        <img src="{{ $driver->driver_image }}" style="width:50px; height: 50px" value="{{ $driver->id }}" selected>
                                    </div>
                                </div> --}}
                            </div>
