                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="input-group" style="position: relative">
                                            ...
                                            <div class="form-group label-floating">
                                                ...
                                                <a href="javascript::void(0)"  style="position: absolute;top: 30%;right: 10px;color: #333"><i class="fa fa-eye"></i></a>
                                            </div>
                                            <div class="form-group">
                                                <a href="{{ route('forgotPass') }}" class="float-right"  style="position: absolute;top: -50%;right: 90px;">Forgot password ?</a>
                                            </div>
                                        </div> 
